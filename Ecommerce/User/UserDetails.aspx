<%@ Page Language="C#" MasterPageFile="~/User/User.Master"
    AutoEventWireup="true" CodeBehind="UserDetails.aspx.cs"
    Inherits="Ecommerce.User.UserDetails" %>
            ...
            <div class="col-lg-7 mb-5">
                <div class="contact-form">
                   ...
                   <%-- <form name="sentMessage" id="contactForm" novalidate="novalidate">--%>
                        ...
                        <div class="control-group">
                            <asp:TextBox runat="server" ID="txtMobile" CssClass="form-control" placeholder="Mobile Phone"  />  
                             <p class="help-block text-danger"></p>
                        </div> 
                        <div class="control-group">
                        ...
                        <div>
                             <asp:Button CssClass="btn btn-primary py-2 px-4" runat="server" Text="Submit" OnClick="btnSubmit_Click" />
                        </div>
                    <%--</form>--%>
                </div>
            </div>
